...
If you use Visual Studio Code with the eslint extension, add the following to your `settings.json` to enable in-editor linting for the files which have been converted to Typescript.
