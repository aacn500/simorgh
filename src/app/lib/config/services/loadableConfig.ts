...
const loadableConfig: LoadableConfigStore = {
  afaanoromoo: {
    ...
    loader: () =>
      (import(
        /* webpackChunkName: 'afaanoromoo' */ './afaanoromoo'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  afrique: {
    loader: () =>
      (import(
        /* webpackChunkName: 'afrique' */ './afrique'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  amharic: {
    loader: () =>
      (import(
        /* webpackChunkName: 'amharic' */ './amharic'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  arabic: {
    loader: () =>
      (import(
        /* webpackChunkName: 'arabic' */ './arabic'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./arabic') as number],
  },
  azeri: {
    loader: () =>
      (import(/* webpackChunkName: 'azeri' */ './azeri') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  bengali: {
    loader: () =>
      (import(
        /* webpackChunkName: 'bengali' */ './bengali'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  burmese: {
    loader: () =>
      (import(
        /* webpackChunkName: 'burmese' */ './burmese'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  cymrufyw: {
    loader: () =>
      (import(
        /* webpackChunkName: 'cymrufyw' */ './cymrufyw'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  gahuza: {
    loader: () =>
      (import(
        /* webpackChunkName: 'gahuza' */ './gahuza'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  gujarati: {
    loader: () =>
      (import(
        /* webpackChunkName: 'gujarati' */ './gujarati'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./gujarati') as number],
  },
  hausa: {
    loader: () =>
      (import(/* webpackChunkName: 'hausa' */ './hausa') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  hindi: {
    loader: () =>
      (import(/* webpackChunkName: 'hindi' */ './hindi') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  igbo: {
    loader: () =>
      (import(/* webpackChunkName: 'igbo' */ './igbo') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  indonesia: {
    loader: () =>
      (import(
        /* webpackChunkName: 'indonesia' */ './indonesia'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  japanese: {
    loader: () =>
      (import(
        /* webpackChunkName: 'japanese' */ './japanese'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  korean: {
    loader: () =>
      (import(
        /* webpackChunkName: 'korean' */ './korean'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  kyrgyz: {
    loader: () =>
      (import(
        /* webpackChunkName: 'kyrgyz' */ './kyrgyz'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  marathi: {
    loader: () =>
      (import(
        /* webpackChunkName: 'marathi' */ './marathi'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./marathi') as number],
  },
  mundo: {
    loader: () =>
      (import(/* webpackChunkName: 'mundo' */ './mundo') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  naidheachdan: {
    loader: () =>
      (import(
        /* webpackChunkName: 'naidheachdan' */ './naidheachdan'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  nepali: {
    loader: () =>
      (import(
        /* webpackChunkName: 'nepali' */ './nepali'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./nepali') as number],
  },
  news: {
    loader: () =>
      (import(/* webpackChunkName: 'news' */ './news') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  pashto: {
    loader: () =>
      (import(
        /* webpackChunkName: 'pashto' */ './pashto'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  persian: {
    loader: () =>
      (import(
        /* webpackChunkName: 'persian' */ './persian'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  pidgin: {
    loader: () =>
      (import(
        /* webpackChunkName: 'pidgin' */ './pidgin'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  portuguese: {
    loader: () =>
      (import(
        /* webpackChunkName: 'portuguese' */ './portuguese'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  punjabi: {
    loader: () =>
      (import(
        /* webpackChunkName: 'punjabi' */ './punjabi'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  russian: {
    loader: () =>
      (import(
        /* webpackChunkName: 'russian' */ './russian'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  serbian: {
    loader: () =>
      (import(
        /* webpackChunkName: 'serbian' */ './serbian'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  sinhala: {
    loader: () =>
      (import(
        /* webpackChunkName: 'sinhala' */ './sinhala'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  somali: {
    loader: () =>
      (import(
        /* webpackChunkName: 'somali' */ './somali'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  swahili: {
    loader: () =>
      (import(
        /* webpackChunkName: 'swahili' */ './swahili'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./swahili') as number],
  },
  tamil: {
    loader: () =>
      (import(/* webpackChunkName: 'tamil' */ './tamil') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  telugu: {
    loader: () =>
      (import(
        /* webpackChunkName: 'telugu' */ './telugu'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./telugu') as number],
  },
  thai: {
    loader: () =>
      (import(/* webpackChunkName: 'thai' */ './thai') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  tigrinya: {
    loader: () =>
      (import(
        /* webpackChunkName: 'tigrinya' */ './tigrinya'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  turkce: {
    loader: () =>
      (import(
        /* webpackChunkName: 'turkce' */ './turkce'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  ukchina: {
    loader: () =>
      (import(
        /* webpackChunkName: 'ukchina' */ './ukchina'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  ukrainian: {
    loader: () =>
      (import(
        /* webpackChunkName: 'ukrainian' */ './ukrainian'
      ) as unknown) as Promise<WrappyThing<Service>>,
    webpack: () => [require.resolveWeak('./ukrainian') as number],
  },
  urdu: {
    loader: () =>
      (import(/* webpackChunkName: 'urdu' */ './urdu') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  uzbek: {
    loader: () =>
      (import(/* webpackChunkName: 'uzbek' */ './uzbek') as unknown) as Promise<
        WrappyThing<Service>
      >,
  ...
  vietnamese: {
    loader: () =>
      (import(
        /* webpackChunkName: 'vietnamese' */ './vietnamese'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  yoruba: {
    loader: () =>
      (import(
        /* webpackChunkName: 'yoruba' */ './yoruba'
      ) as unknown) as Promise<WrappyThing<Service>>,
  ...
  zhongwen: {
    loader: () =>
      (import(
        /* webpackChunkName: 'zhongwen' */ './zhongwen'
      ) as unknown) as Promise<WrappyThing<Service>>,
